...
def test_admin_navigation_active_account():
    ...
    rendered_template = render_to_string('partials/nav_admin.html', {'request': request, 'active': 'account'})
...
def test_admin_navigation_active_products():
    ...
    rendered_template = render_to_string('partials/nav_admin.html', {'request': request, 'active': 'products'})
