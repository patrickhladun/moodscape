...
describe("FAQ UI and Accessibility Tests", () => {
  beforeEach(() => {
    cy.visit("/faq/");
  });
  ...
  it("should have the correct headers", () => {
    ...
    cy.get("h3")
      ...
      .should("exist");
    cy.get("h3")
      .contains("3. What payment methods do you accept?")
      .should("exist");
    ...
    cy.get("h3")
      .contains("7. How long does it take to process an order?")
      .should("exist");
    cy.get("h3")
      .contains("8. Can I change or cancel my order?")
      .should("exist");
    cy.get("h3").contains("9. What is your return policy?").should("exist");
    cy.get("h3").contains("10. How do I return an item?").should("exist");
    cy.get("h3")
      .contains("11. How long does it take to receive a refund?")
      .should("exist");
    cy.get("h3").contains("12. Can I exchange an item?").should("exist");
    cy.get("h3")
      .contains("13. Are all the art pieces original?")
      .should("exist");
    cy.get("h3")
      .contains("14. Do you offer custom art pieces?")
      .should("exist");
