...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('user', '0002_remove_user_user_type_customer'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='orders', to='user.customer')),
            ],
            options={
                'verbose_name': 'Order',
